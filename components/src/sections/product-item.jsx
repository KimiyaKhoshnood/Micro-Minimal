...
import { ColorPreview } from '../component/color-utils/color-preview';
...
export function ProductItem({ product }) {
  ...
  const renderContent = (
    <Stack spacing={2.5} sx={{ p: 3, pt: 2 }}>
      ...
      <Link component={"span"} href={""} color="inherit" variant="subtitle2" noWrap>
        {name}
      </Link>
  ...
  return (
    <Card sx={{ borderRadius: 4, '&:hover .add-cart-btn': { opacity: 1 } }}>
      {renderLabels}
