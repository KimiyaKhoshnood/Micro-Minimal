...
import { CarouselDotButtons } from '../../component/carousel/components/carousel-dot-buttons';
...
export function BankingCurrentBalance({ list, sx, ...other }: { list?: any, sx?: any, [other: string]: any }) {
...
function Item({ item, showCurrency, onToggleCurrency }: { item?: any, showCurrency?: any, onToggleCurrency?: any }) {
