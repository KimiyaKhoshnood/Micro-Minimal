...
export function BankingOverview({ sx, ...other }: { sx?: any, [other: string]: any }) {
  ...
  const chartOptions = useChart({
    ...
    stroke: { width: 3 },
    tooltip: {
      y: { formatter: (value:any) => fCurrency(value), title: { formatter: () => '' } },
    },
  });
