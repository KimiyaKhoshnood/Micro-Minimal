...
import { BackgroundShape } from '../../../upload/components/upload-illustration';
...
function OrderCompleteIllustration({ hideBackground, sx, ...other }:{ hideBackground?:any, sx?:any, [other:string]:any }) {
  // const theme = useTheme();

  const PRIMARY_LIGHT = "#efefef";

  const PRIMARY_MAIN = "#efefef";

  const PRIMARY_DARK = "#efefef";

  const PRIMARY_DARKER = "#efefef";
