...
export function OrderTableRow({ row, selected, onViewRow, onSelectRow, onDeleteRow }: { row: any, selected: any, onViewRow: () => void, onSelectRow: () => void, onDeleteRow: () => void }) {
            ...
            {row.items.map((item:any) => (
              <Stack
                ...
                sx={{
                  ...
                  '&:not(:last-of-type)': {
                    borderBottom: (theme:any) => `solid 2px ${theme.vars.palette.background.neutral}`,
                  },
                }}
              >
                <Avatar
