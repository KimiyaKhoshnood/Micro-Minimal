...
function NavSubList({ data, depth, render, cssVars, slotProps, enabledRootRedirect }: { data?: any, depth?: any, render?: any, cssVars?: any, slotProps?: any, enabledRootRedirect?: any }) {
  return (
    <NavUl sx={{ gap: 0.5 }}>
      {data.map((list:any) => (
        <NavList
