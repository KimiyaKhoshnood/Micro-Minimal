...
export function NavList({ data, depth, render, cssVars, slotProps, enabledRootRedirect }: { data?: any, depth?: any, render?: any, cssVars?: any, slotProps?: any, enabledRootRedirect?: any }) {
...
function NavSubList({ data, render, depth, slotProps, enabledRootRedirect, cssVars }: { data?: any, render?: any, depth?: any, slotProps?: any, enabledRootRedirect?: any, cssVars?: any }) {
  return (
    <NavUl sx={{ gap: 0.5 }}>
      {data.map((list:any) => (
        <NavList
