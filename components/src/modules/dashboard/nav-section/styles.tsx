...
import { navSectionClasses } from './classes';
import { Iconify, iconifyClasses } from '../../../component/iconify/iconify';
import { svgColorClasses } from '../../../component/svg-color/svg-color';

// ----------------------------------------------------------------------

export function stateClasses({ open, active, disabled }:{ open?:any, active?:any, disabled?:any }) {
...
export function Subheader({ sx, open, children, ...other }: { sx?: any, open?: any, children?: any, [other: string]: any }) {
  return (
    <ListSubheader
      disableSticky
      component="div"
...
export function NavCollapse({ sx, depth, children, ...other }: { sx?: any, depth?: any, children?: any, [other: string]: any }) {
  return (
    <Collapse
      sx={{
        ...(depth + 1 !== 1 && {
...
export function NavLi({ sx, children, disabled, ...other }: { sx?: any, children?: any, disabled?: any, [other: string]: any }) {
  return (
    <Box
      component="li"
...
export function NavUl({ children, sx, ...other }: { children?: any, sx?: any, [other: string]: any }) {
  return (
    <Box
      component="ul"
