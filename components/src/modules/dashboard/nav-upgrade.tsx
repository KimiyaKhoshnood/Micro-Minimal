...
export function NavUpgrade({ sx, ...other }: { sx?: any, [other: string]: any }) {
...
export function UpgradeBlock({ sx, ...other }: { sx?: any, [other: string]: any }) {
  return (
    <Stack
      sx={{
        ...bgGradient({
    ...
    >
      <Box
        sx={{
          ...
          borderRadius: 2,
          position: 'absolute',
          border: (theme: any) => `solid 3px ${varAlpha(theme.vars.palette.common.whiteChannel, 0.16)}`,
        }}
      />
