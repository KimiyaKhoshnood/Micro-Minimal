...
})<{ axis: string, slideSpacing: string }>(({ axis, slideSpacing }) => ({
  display: 'flex',
...
export function Carousel({ carousel, children, sx, slotProps }: { carousel: any, children: any, sx?: any, slotProps?: any }) {
